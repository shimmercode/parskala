...
$header_minicart_icon = prk_option('header_minicart_icon');
...
<header class="header <?php echo $device. ' '.$sticky_classes.''. $header_type.' '.$position_type.' '.$location_class; ?>">
  ...
  <div  class="continer noselect_moblie">
    ...
    <?php if ($header_minicart):?>
      ...
      <?php if ( $header_minicart_type == 'link' ):?>
        ...
        <a class="cart-modals" href="<?php echo wc_get_cart_url(); ?>">
