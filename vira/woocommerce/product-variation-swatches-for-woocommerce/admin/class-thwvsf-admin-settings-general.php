...
class THWVSF_Admin_Settings_General extends THWVSF_Admin_Settings{
	...
	public function get_global_settings_fields(){
		...
		return array(
			...
			'show_item_on_label' => array('name'=>'show_item_on_label', 'label'=>__('Show Selected Attribute Item ', 'product-variation-swatches-for-woocommerce'), 'type'=>'checkbox','hint_text'=>'Show selected attribute item with attribute label on single product page', 'value'=>'yes', 'checked'=>0),
	...
	*******************************/
	...
	private function render_global_settings($settings){
		...
		<?php /*<tr>
			<?php
			$this->render_form_field_element($this->global_fields['show_item_on_label'], $this->cell_props_CB);
			?>							
		</tr> */?>
		<tr>
			<?php
