<?php
	...
	add_action('woocommerce_single_product_summary', function(){
		prk_remove_class_action('woocommerce_after_single_product_summary', 'Dokan_SPMV_Products', 'show_vendor_comparison', 1);
		
		prk_remove_class_action('woocommerce_product_tabs', 'Dokan_SPMV_Products', 'show_vendor_comparison_inside_tab');
        prk_remove_class_action('woocommerce_order_details_after_order_table', 'Dokan_SPMV_Products', 'generate_support_button_customer_order_page',11);
