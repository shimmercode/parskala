...
<?php if (prk_option('form_login_style') == 'style_2' ): ?>
          ...
          <div  class="modal__container" style="width: 31%;max-width: 500px;position: relative;">
            ...
            <div class="rtl-sec-login">
                  ...
                  <div class="logo-loginbox">
                    ...
                    <a href="<?php bloginfo('url');?>"> <?php echo prk_sms_form_style_2(); ?> </a>
            ...
            <div class="auth-modal-content">
              ...
              <section class="prk-loginbox">
                ...
                <div class="footer-loginbox">
                  <p class="copyright-login-footer">با ورود و یا ثبت نام در سایت شما <a class="linkp" href="<?php echo $url_pages;?>" target="_blank">شرایط و قوانین</a> استفاده از سرویس های سایت و <a href="#" target="_blank">قوانین حریم خصوصی</a> آن را می&zwnj;پذیرید.	</p>
                </div>
