<?php
 ...
 <div class="remodal modal-better remodal-lg remodal-maxed" data-remodal-id="modal-better" data-remodal-options="hashTracking: false">
   ...
   <div class="remodal-header">
      <span class="title-feed"><?php echo _e( 'Price report for', 'parskala' ); ?> <?php the_title();?></span>
      ...
      <label for="better_price"><?= __ ('What price have you seen this product at?','parskala') ;?></label>
      <input type="text" name="better_price" id="better_price" placeholder="<?= _e('For example, 42,000','parskala') ?>">
      <span class="input_better"><?php _e ('Toman','parskala');?></span>
        </p>
       <div class="flex_right swicher">
        <label class="switch">
          ...
          <span class="slider"></span>
            ...
            <label class="swich_before" for="swich_before"><?php _e ('I have seen it in the online store','parskala');?></label>
           </div>
        <p class="form-better site show">
      <label for="better_price"><?php _e ('Store web address','parskala');?></label>
      <input type="text" name="better_url" id="better_url" placeholder="www.example.com">
        </p>
        <p class="form-better shop">
      <label for="better_price"><?php _e ('store name','parskala');?></label>
      <input type="text" name="better_name" id="better_name">
        </p>
        <p class="form-better shop">
      <label for="better_price"><?php _e ('Store location','parskala');?></label>
      <input type="text" name="better_city" id="better_city" placeholder="tehran">
        </p>
        <span data-remodal-action="close" class="insert-better"><?php _e ('submit information','parskala');?></span>
         </div>
        </div>
</div>
