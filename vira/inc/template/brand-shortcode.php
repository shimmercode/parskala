  ...
  <div class="brands-search">
    <form class="form_search_brndpage" action="<?php bloginfo('url');?>" method="get">
      <div class="searchpartdiv">
        ...
        <input id="text_search_brands" class="input_field searchcity-input" type="text" name="s" oninput="ajax_brands_search();" value="" autocomplete="off" placeholder="<?= _e('جستجو در برندها','parskala')?>">
      </div>
    </form>
  </div>
  <?php
