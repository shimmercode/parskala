<?php
class news_carosel_Widget extends \Elementor\Widget_Base {
...
$this->add_control(
  ...
  [
             ...
             [
                ...
                'default' => 'yes',
									...
									$this->add_group_control(
											...
											[
												'name' => 'رنگ پس زمینه سکشن',
												'label' => esc_html__( 'رنگ پس زمینه سکشن', 'plugin-name' ),
												'types' => [ 'classic', 'gradient', 'video' ],
												'selector' => '{{WRAPPER}} .right-product.news',
											]
				);
	...
	protected function render() {
		...
		$json_settings = wp_json_encode($settings_slider);

		?>
    <section class="col-product">
       <div class="right-product tab1  news">

				 <div class="head-product news">
				<h3>
					<span class="titles-pro">
					<span><?php echo $settings['title_section'];?></span>
				</span>
				<a class="view-all news" href="<?php echo $settings['categoryـurl']['url'];?>"><?php _e('viwe all' , 'parskala');?></a>
			</h3>
				</div>

      <div class="article-off owl-carousel" settings-slider="<?php echo esc_attr($json_settings); ?>">
        <?php
        ...
        $category =  $settings['category'];
             ...
             <?php if ( $pd_query ->have_posts() ) : ?>
               <?php while ( $pd_query ->have_posts() ) : $pd_query ->the_post(); ?>
                 <article  class="item-index home-blog news">
                  ...
                  <div class="title-item-index news">
