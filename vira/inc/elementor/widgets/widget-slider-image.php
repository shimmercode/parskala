...
class sldier_image_Widget extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'اسلایدر تصویر', 'prk' );
	}

  public function get_icon() {
    return 'icon-image-rollover';
  }
  ...
  public function get_categories() {
	...
	protected function register_controls() {
		...
		$this->add_control(
				...
				[
					...
					'default' => '8',
					'selectors' => [
						'{{WRAPPER}} .swiper-image-slider' => 'border-radius: {{VALUE}}px',
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .swiper-image-slider'  => 'box-shadow: {{HORIZONTAL}}px {{VERTICAL}}px {{BLUR}}px {{SPREAD}}px {{COLOR}} ;',
				],
			]
		);
	...
	<div class="swiper-image-slider <?=  $settings['dots_style'] ?>">

		<div class="swiper-wrapper">

			<?php foreach (  $settings['list'] as $item ): ?>

				<div class="swiper-slide parskala_image">

					<a href="<?php echo $item['list_link'];?>">

				     	<?= \Elementor\Group_Control_Image_Size::get_attachment_image_html($item, 'shop_catalog', 'list_image'); ?>
...
<script>
            ...
            jQuery(document).ready(function($) {
                var swiper9cbc9d7 = new Swiper(".swiper-image-slider", {
