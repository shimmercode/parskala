...
if ( ! class_exists( 'CSF_Options' ) ) {
  class CSF_Options extends CSF_Abstract {
    ...
    public $args         = array(
      ...
      // menu settings
      'menu_title'              => 'پنل تنظبمات پارس کالا',
      'menu_slug'               => 'opt_prk',
      'menu_type'               => 'menu',
    ...
    public function add_admin_footer_text() {
      $default = 'ممنونیم از اینکه پارس کالا را به عنوان کشتی تجارت خود انتخاب کرده ایید !</a>';
      ...
      echo '<div class="csf csf-options'. esc_attr( $theme . $class . $wrapper_class ) .'" data-slug="'. esc_attr( $this->args['menu_slug'] ) .'" data-unique="'. esc_attr( $this->unique ) .'">';
        ...
        echo '<div class="csf-header-inner">';
          ...
          echo '<div class="csf-header-left">';
            ...
            echo '<div class="prk-sidebar-logo">';
              echo '<img src="'.get_bloginfo('template_url'). '/assets/img/icon/favicon.png'.'" alt="" >';
            echo '</div>';

            echo '<div class="prk-sidebar-des">';
              echo '<div class="title-setting-opt"><a href="#">'. $this->args['framework_title'] .'</a><span class="prk-version">نسخه کنونی  '.PRK_VERSION.' </span></div>';
              echo '<p>'. parskala_desc2 .'</p>';
            echo '</div>';  
    ...
    // }else {
    //   echo '<div class="panel_not_active">
    //     <p>
    //       کاربر عزیز لایسنس شما فعال نمی باشد بعد از ثبت و فعال سازی لایسنس ، این صفحه را مجددا لود نمایید.
    //     </p>
    //     </div>';
    // }
  }
