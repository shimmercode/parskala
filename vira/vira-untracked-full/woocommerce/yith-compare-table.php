...
<div id="yith-woocompare" class="woocommerce">
	...
	<?php
        if ( empty( $products ) ):
            echo '<p>' . apply_filters( 'yith_woocompare_empty_compare_message', __( 'No products added in the comparison table.', 'yith-woocommerce-compare' ) ) . '</p>';
        else:
    ?>
                            ...
                            switch( $field ) {
                                ...
                                case 'product_info':
                                    ...
                                    if( $show_image || $show_title ) {
                                        ...
                                        if( $show_image )
	                                        echo '<div class="image-wrap">' . $product->get_image( 'shop_catalog' ) . '</div>';
	                                    if( $show_title )
